...
function firebaseNotification($title, $body, $image, $data, $type)
{
    ...
    $mybody = $body;
    $myimage = $image;
    $optional_data["type"] = $type;
    $optional_data["post"] = $data;
    $optional_data["click_action"] = 'FLUTTER_NOTIFICATION_CLICK';
    $optional_data["status"] = 'done';
    $notification = array('title' => $mytitle, 'body' => $mybody, "image" => $myimage, 'sound' => 'default', 'badge' => '1');
    $arrayToSend = array('to' => $token, 'notification' => $notification, "content_available" => true, "mutable_content" => true, 'data' => $optional_data, 'priority' => 'high');
